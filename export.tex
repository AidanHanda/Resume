    ...
    \thispagestyle{empty}
            ...
            \section{Education}
                ...
                \textit{Bachelor of Science in Computer Science \hfill {\normalsize \textnormal{GPA: 4.0}}}
                                    ...
                                    \makeposition{DreamHire.io}{Software Engineering Intern}{Remote - San Francisco, CA}{September 2018 - August 2019}
                \begin{itemize}
                                    ...
                                    \end{itemize}
                                \section{Projects}
                                    \makeposition{Xplicate}{A data backed AI agent designed to summarize complex medical research papers}{Naperville, IL}{May 2020}
                \begin{itemize}
                                    ...
                                    \end{itemize}
                            \makeposition{Isolation AI}{An intelligent agent trained genetically to play the game Isolation}{Atlanta, GA}{December 2019}
                \begin{itemize}
                                    ...
                                    \end{itemize}
                            \makeposition{Lilac}{An artifically intelligent personal shopper built over a span of 36 hours at HackGT.}{Atlanta, GA}{November 2019}
                \begin{itemize}
                                    ...
                                    \end{itemize}
                            \makeposition{Go Music-Bot}{An online collaborative music server application for use in group settings.}{Naperville, IL}{January 2019 - March 2019}
                \begin{itemize}
                                ...
                                \section{Leadership Experience}
                                    \makeposition{Urban Smart Shoes}{Lead Designer}{Naperville, IL}{May 2019 - July 2019}
                \begin{itemize}
                                    ...
                                    \end{itemize}
                            \makeposition{App-I-Tite}{Lead Software Engineer}{Naperville, IL}{January 2018 - May 2018}
                \begin{itemize}
